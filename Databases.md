...
The original artifact is a sample SQL HR database that I was using to help myself learn SQL at one point. I remember that I was using this at the time that I was taking a SQL course when I was enrolled at Massasoit Community College, just to get some extra practice with SQL. 
   
### Justify the inclusion of the artifact in your ePortfolio. Why did you select this item? What specific components of the artifact showcase your skills and abilities in # software development? How was the artifact improved?

The reason that I selected this item was because I felt it would be a good example of my ability and understanding of databases. Specifically, I feel that the tables that are created and the data that is inserted into the tables is a good showcase of my understanding of databases. To improve the original database, I decided that I would take the dependents table and add a last name column, as I feel that is important information. A dependent may not have the same last name as the employee, so it is a good idea to have the last name on file. To make this enhancement, I decided that I would delete all of the data from the table and then drop the table altogether. I decided to do this to show my understanding of clearing and dropping tables. From there, I re-created the dependents table with all of the same variables included, plus the last names. I then inserted the data for the dependents (including last names) into the new table. 


## Sample HR Database creation
...
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (1,'Penelope','Child',206);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (2,'Nick','Child',205);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (3,'Ed','Child',200);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (4,'Jennifer','Child',100);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (5,'Johnny','Child',101);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (6,'Bette','Child',102);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (7,'Grace','Child',109);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (8,'Matthew','Child',110);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (9,'Joe','Child',111);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (10,'Christian','Child',112);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (11,'Zero','Child',113);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (12,'Karl','Child',108);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (13,'Uma','Child',203);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (14,'Vivien','Child',103);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (15,'Cuba','Child',104);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (16,'Fred','Child',105);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (17,'Helen','Child',106);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (18,'Dan','Child',107);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (19,'Bob','Child',201);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (20,'Lucille','Child',202);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (21,'Kirsten','Child',204);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (22,'Elvis','Child',115);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (23,'Sandra','Child',116);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (24,'Cameron','Child',117);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (25,'Kevin','Child',118);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (26,'Rip','Child',119);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (27,'Julia','Child',114);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (28,'Woody','Child',145);
INSERT INTO dependents(dependent_id,first_name,relationship,employee_id) VALUES (29,'Alec','Child',146);
...
/* Show all data from dependents table */
SELECT * FROM dependents 

/* Delete all data from dependents table */
DELETE FROM dependents

/* Confirm all data from dependents table has been deleted */
SELECT * FROM dependents 
 
/* Drop the dependents table */
DROP TABLE dependents

/* Create new dependents table with last name variable included */
CREATE TABLE dependents (
dependent_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	first_name VARCHAR2 (50) NOT NULL,
